  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/60 p-4">
      ...
      >
        ...
        <p className="font-mono text-xs text-ink/40">Stock actual: {producto.stock_actual}</p>
        ...
        <div className="mt-4 space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-surface-2 px-3 py-2 text-sm text-ink outline-none placeholder:text-ink/40 focus:border-amber"
            />
          </div>
        </div>
